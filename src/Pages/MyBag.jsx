...
function MyBag() {
  ...
  return (
    <div className='w-full  flex flex-col'>
        ...
        <div className="w-full flex justify-center items-end gap-2 text-2xl sego font-semibold ">My Bag</div>
        <div className=" mt-4 flex flex-wrap mx-auto border-black  w-[97%] ">
            <div className="md:flex-[2]  w-full p-2 px-7">
